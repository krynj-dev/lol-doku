...
def get_pentakills(site: EsportsClient, levels=['Primary', 'Secondary'], write=True, write_loc=None):
    responses = read_all_from_table(
        site=site,
...
def get_champ_counts_mp(site: EsportsClient, champions_to_get: list, names_to_get: list, write=True):
    size = 25
    # split into chunks
