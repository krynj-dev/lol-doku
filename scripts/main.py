...
if __name__ == "__main__":
    ...
    if "--update" in sys.argv:
        perform_data_update(site, time=dt.datetime(2025, 3, 10))
        quit()
    ...
    if "--cook" in sys.argv:
        ...
        teams_cooked = cook_teams_data(
            teams, sister_teams, team_renames, team_redirects, rosters
        )
    else:
    ...
    if "--create-rules" in sys.argv:
        team_rules, teammate_rules, role_rules = create_team_teammate_role_rules(
            teams_cooked, players_cooked, rosters
        )
        ...
        finalists_rules = create_worlds_finalist_rules(
            players_cooked, tournament_results
        )
