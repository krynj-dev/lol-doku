...
class RosterLink(models.Model):
    ...
    roster = models.ForeignKey(
        Roster, on_delete=models.CASCADE, related_name="roster_links", null=False
    )
    player = models.ForeignKey(
        Player, on_delete=models.CASCADE, related_name="player_links", null=False
    )
...
class Pro2ProPlayerPuzzle(models.Model):
    player_from = models.ForeignKey(
        Player, on_delete=models.CASCADE, related_name="player_from", null=False
    )
    player_to = models.ForeignKey(
        Player, on_delete=models.CASCADE, related_name="player_to", null=False
    )


class Pro2ProRosterPuzzle(models.Model):
    roster_from = models.ForeignKey(
        Roster, on_delete=models.CASCADE, related_name="roster_from", null=False
    )
    roster_to = models.ForeignKey(
        Roster, on_delete=models.CASCADE, related_name="roster_to", null=False
    )
