...
class GameRoster(models.Model):
    ...
    puzzle = models.ForeignKey(
        Puzzle, on_delete=models.CASCADE, related_name="puzzle_roster"
    )


class Game(models.Model):
    rostered_puzzle = models.ForeignKey(
        GameRoster, on_delete=models.CASCADE, related_name="games"
    )
...
class GameGuess(models.Model):
    ...
    player = models.ForeignKey(
        Player, on_delete=models.CASCADE, related_name="guesses", null=True, blank=True
    )
